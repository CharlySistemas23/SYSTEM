...
router.post('/', asyncHandler(async (req, res) => {
    ...
    req.io.to(`branch_${branchId}`).emit('employee-created', employee);
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    req.io.to(`branch_${targetBranchId}`).emit('employee-updated', updatedEmployee);
...
router.delete('/:id', asyncHandler(async (req, res) => {
    ...
    // Emitir evento WebSocket
    req.io.to(`branch_${employee.branch_id || branchId}`).emit('employee-deleted', { id });
