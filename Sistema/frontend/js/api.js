...
const API = {
    // URL base del servidor (configurable desde localStorage o usar default)
    baseURL: localStorage.getItem('api_base_url') || 'https://system-production-9e21.up.railway.app',
