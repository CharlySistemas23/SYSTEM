...
import { sanitizeString, sanitizeEmail, sanitizeNumber, sanitizeObject } from '../utils/sanitize.js';
...
router.post('/', asyncHandler(async (req, res) => {
    ...
    const sanitizedBody = sanitizeObject(req.body, {
        inventory_item_id: { type: 'string', options: {} },
        customer_name: { type: 'string', options: { maxLength: 200 } },
        customer_phone: { type: 'string', options: { maxLength: 50 } },
        customer_email: { type: 'email', options: {} },
