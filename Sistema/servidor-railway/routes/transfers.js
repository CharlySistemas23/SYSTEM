...
router.post('/', asyncHandler(async (req, res) => {
    ...
    emitToBranch(req.io, fromBranchId, 'transfer-created', transfer);
    emitToBranch(req.io, to_branch_id, 'transfer-created', transfer);
...
router.put('/:id/confirm', asyncHandler(async (req, res) => {
    ...
    // Emitir evento WebSocket a ambas sucursales
    emitToBranch(req.io, transfer.from_branch_id, 'transfer-updated', updatedTransfer);
    emitToBranch(req.io, transfer.to_branch_id, 'transfer-updated', updatedTransfer);
