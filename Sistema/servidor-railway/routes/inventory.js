...
router.post('/', asyncHandler(async (req, res) => {
    ...
    emitToBranch(branchId, 'inventory-item-created', item);
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    emitToBranch(branchId, 'inventory-item-updated', updatedItem);
...
router.delete('/:id', asyncHandler(async (req, res) => {
    ...
    // Emitir evento WebSocket
    emitToBranch(branchId, 'inventory-item-deleted', { id });
