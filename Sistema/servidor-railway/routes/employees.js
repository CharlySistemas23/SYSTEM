...
router.post('/', asyncHandler(async (req, res) => {
    ...
    emitToBranch(branchId, 'employee-created', employee);
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    emitToBranch(targetBranchId, 'employee-updated', updatedEmployee);
...
router.delete('/:id', asyncHandler(async (req, res) => {
    ...
    // Emitir evento WebSocket
    emitToBranch(employee.branch_id || branchId, 'employee-deleted', { id });
