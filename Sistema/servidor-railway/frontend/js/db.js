...
const DB = {
    ...
    storeToEndpoint: {
        ...
        // Estos stores aún no tienen endpoints específicos - usar getAll con filtros
        'catalog_agencies': null, // TODO: crear endpoint
        'catalog_guides': null, // TODO: crear endpoint
        'catalog_sellers': null, // TODO: crear endpoint
    ...
    async delete(storeName, key) {
        const endpoint = this.getEndpoint(storeName);
        if (!endpoint) {
            console.warn(`Store ${storeName} no tiene endpoint mapeado`);
            throw new Error(`Store ${storeName} no soportado`);
        }
    ...
    async query(storeName, indexName, query, options = {}) {
        // Query es básicamente getAll con filtros
        return await this.getAll(storeName, indexName, query, options);
    },
