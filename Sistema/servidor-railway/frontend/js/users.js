...
const UserManager = {
    ...
    async init() {
        this.setupLogin();
        // checkAuth deshabilitado - sistema accesible sin login
        // this.checkAuth();
        
        // Simular usuario admin para que el sistema funcione sin login
        this.currentUser = {
            id: 'user_admin_001',
            username: 'admin',
            role: 'admin',
        ...
        // Configurar API con usuario simulado
        ...
        // Actualizar UI con usuario simulado
        if (typeof UI !== 'undefined' && UI.updateUserInfo && this.currentEmployee) {
            UI.updateUserInfo(this.currentEmployee);
        }
        
        if (typeof UI !== 'undefined' && UI.updateAdminNavigation) {
            UI.updateAdminNavigation(true);
        }
        
        console.log('✅ Sistema accesible sin login (modo desarrollo)');
    },
    ...
    setupLogin() {
        ...
        // Botón para configurar usuario admin
        const setupAdminBtn = document.getElementById('setup-admin-btn');
        if (setupAdminBtn) {
            setupAdminBtn.addEventListener('click', () => this.setupAdmin());
        }
