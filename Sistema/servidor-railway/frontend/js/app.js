...
// Debug code removed - DB ya no tiene .db (usando API ahora)
            ...
            // Cargar datos básicos del sistema si hay token o usuario simulado (se cargará después del login si no hay token)
            // Cargar en background sin bloquear (no await)
    ...
    async loadSystemData() {
        ...
        try {
            ...
            if (isTableError) {
                ...
                Utils.showNotification('⚠️ Base de datos incompleta. Ejecuta la migración desde la consola del backend.', 'error');
            } else {
