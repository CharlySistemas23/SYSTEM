...
const Utils = {
    ...
    showNotification(message, type = 'info', duration = 3000) {
        // Limpiar notificaciones anteriores del mismo tipo si hay muchas
        ...
        notification.style.cssText = `
            position: fixed;
            top: ${80 + (existingNotifications.length * 60)}px;
            right: 20px;
            min-width: 300px;
            max-width: 500px;
            padding: 12px 16px;
    ...
    showError(message, error = null, options = {}) {
        ...
        this.showNotification(errorMessage, 'error', options.duration || 5000);
    ...
    showLoading(message = 'Cargando...', target = null) {
        ...
        loading.style.cssText = `
            ...
            ${target ? '' : 'top: 0; left: 0; right: 0; bottom: 0;'}
