...
const BranchSelector = {
    ...
    async init() {
        ...
        this.isAdmin = currentUser.role === 'admin' || currentUser.permissions?.includes('all');
    ...
    handleBranchChange(branchId) {
        ...
        // Emitir evento para que otros módulos sepan que cambió la sucursal
        window.dispatchEvent(new CustomEvent('branch-filter-changed', {
