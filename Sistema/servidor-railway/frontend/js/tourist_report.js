...
const TouristReport = {
        ...
        while (!catalogsLoaded && attempts < maxAttempts) {
            try {
                ...
                if (attempts < maxAttempts - 1) {
                    ...
                    console.log('⚠️ Catálogos no cargados en TouristReport, continuando...');
                    catalogsLoaded = true;
                }
            } catch (e) {
                console.error('Error verificando catálogos en TouristReport:', e);
                catalogsLoaded = true;
                break;
            }
        }
    ...
    async displayArrivals() {
        ...
        const branchName = branch?.name || 'Tienda 1';
